...
DATASETS = {
    ...
    "finance_contributions": {
        ...
        "output": f"{silver_bucket}/finance_contributions/finance_contributions_clean.parquet",
    ...
    "unfunded_liabilities": {
        ...
        "output": f"{silver_bucket}/unfunded_liabilities/unfunded_liabilities_clean.parquet",
